...
RULES = "\n".join([
    ...
    '- Bloom season: Spring / early Summer / Summer / late Summer / early Fall / Fall. Use "early" or "late" prefix when bloom < half a season. When bloom spans multiple seasons (e.g. July-October), anchor to peak or starting season — prefer "early Fall" over "late Summer" when bloom continues into fall.',
    ...
    '- Native range: "North America, NC native" if NC native, "North America" if not, "Asia", "Europe" etc. Never list US states.',
